...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.hw1InfoText = QtGui.QWidget(self.centralwidget)
        self.hw1InfoText.setMaximumSize(QtCore.QSize(16777215, 30))
        self.hw1InfoText.setObjectName(_fromUtf8("hw1InfoText"))
        self.horizontalLayout.addWidget(self.hw1InfoText)
        self.labInfotext = QtGui.QLabel(self.centralwidget)
        self.labInfotext.setMaximumSize(QtCore.QSize(16777215, 30))
        self.labInfotext.setStyleSheet(_fromUtf8("text-align: center"))
        self.labInfotext.setObjectName(_fromUtf8("labInfotext"))
        self.horizontalLayout.addWidget(self.labInfotext)
        self.hw2InfoText = QtGui.QWidget(self.centralwidget)
        self.hw2InfoText.setMaximumSize(QtCore.QSize(16777215, 30))
        self.hw2InfoText.setObjectName(_fromUtf8("hw2InfoText"))
        self.horizontalLayout.addWidget(self.hw2InfoText)
        self.horizontalLayout.setStretch(0, 5)
        self.horizontalLayout.setStretch(1, 1)
        self.horizontalLayout.setStretch(2, 5)
        self.verticalLayout_4.addLayout(self.horizontalLayout)
        self.hwInfotext = QtGui.QWidget(self.centralwidget)
        self.hwInfotext.setMaximumSize(QtCore.QSize(16777215, 30))
        self.hwInfotext.setObjectName(_fromUtf8("hwInfotext"))
        self.verticalLayout_4.addWidget(self.hwInfotext)
        ...
        self.menuDateu.addAction(self.actionSchliessen)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSchliessen.setText(_translate("MainWindow", "Schließen", None))
